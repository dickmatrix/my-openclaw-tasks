...
name: canvas
description: |
  Display HTML content on connected OpenClaw nodes (Mac, iOS, Android apps). Use when presenting web content, visualizations, dashboards, or interactive demos on a node's canvas view.
---
