...
const FeishuSharedConfigShape = {
  ...
  /** Delay before starting the Feishu WebSocket client (per account). Staggers multi-bot startups/restarts. */
  reconnectDelayMs: z.number().int().min(0).max(300_000).optional(),
};
